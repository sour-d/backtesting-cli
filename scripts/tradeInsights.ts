...
Options:
  ...
  --risk-per-trade <n>   Fixed $ risk for R = PnL / risk (like old engine)
  --capital <n>          If set with no --risk-per-trade, risk = capital * 5% (old default risk label)
